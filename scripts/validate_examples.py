...
VALIDATION_TARGETS = [
    ...
    {
        "name": "Collective Rhythm Route",
        "schema": ROOT / "schemas" / "collective-rhythm-route.schema.json",
        "example": ROOT / "examples" / "collective-rhythm-route.example.yaml",
    },
    {
        "name": "Collective Exhalation Bridge",
